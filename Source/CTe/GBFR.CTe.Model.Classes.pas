...
type
  ...
  TGBFRCTeModelAutDownloadXML      = GBFR.CTe.Model.AutDownloadXML.TGBFRCTeModelAutDownloadXML;
  ...
  TGBFRCTeModelInfoModal           = GBFR.CTe.Model.InfoModal.TGBFRCTeModelInfoModal;
